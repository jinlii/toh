...
var HeroService = /** @class */ (function () {
    ...
    HeroService.prototype.getHero = function (id) {
        ...
        return this.http.get(url).pipe(// how does it know to get api/heroes/id??
        operators_1.tap(function (_) { return _this.log("fetched hero id=" + id); }), operators_1.catchError(this.handleError("getHero id=" + id)));
    };
...
module.exports = __webpack_require__(/*! C:\Github\toh\src\main.server.ts */"./src/main.server.ts");
